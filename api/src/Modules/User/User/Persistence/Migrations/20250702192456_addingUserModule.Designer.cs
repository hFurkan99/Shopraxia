...
namespace User.Persistence.Migrations
{
    ...
    [Migration("20250702192456_addingUserModule")]
    partial class addingUserModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("User.Domain.UserAggregate.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("User.Domain.UserAggregate.Entities.ApplicationUser", null)
                        .WithMany()
